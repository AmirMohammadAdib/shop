        ...
        <section class="sidebar-wrapper">
            ...
            <section class="sidebar-group-link">
                ...
                <section class="sidebar-dropdown">
                    ...
                    <a href="{{ route("payment.confirm") }}">پرداخت در محل</a>
                </section>
            </section>
            ...
            <section class="sidebar-group-link">
                ...
                <section class="sidebar-dropdown">
                    <a href="{{ route("discount.coupon.index") }}">کپن تخفیف</a>
                    <a href="{{ route("discount.commonDiscount.index") }}">تخفیف عمومی</a>
                    <a href="{{ route("discount.amazingSale.index") }}">فروش شگفت انگیز</a>
                </section>
            </section>
            ...
            <a href="{{ route("ticket.newTicket") }}" class="sidebar-link">
                <i class="fas fa-bars"></i>
                <span>تیکت های جدید</span>
            </a>
            <a href="{{ route("ticket.openTicket") }}" class="sidebar-link">
                <i class="fas fa-bars"></i>
                <span>تیکت های باز</span>
            </a>
            <a href="{{ route("ticket.closeTicket") }}" class="sidebar-link">
                <i class="fas fa-bars"></i>
