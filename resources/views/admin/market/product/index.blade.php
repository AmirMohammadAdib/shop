        ...
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section class="d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
                    <a href="{{ route("product.create") }}" class="btn btn-info btn-sm">ایجاد کالا </a>
                ...
                <section class="table-responsive">
                    <table class="table table-striped table-hover h-150px">
                        ...
                        <tr>
                            <th>1</th>
                            <td>گوشی آیفون 14 pro max مدل dlc30X</td>
                            <td>
                                <img src="https://paytakht136.ir/uploads/d034533050244076bfe6d285aa59c991.jpg" style="width: 5rem;">
                            </td>
                            ...
                            <td class="width-8-rem text-left">
                                <div class="dropdown">
                                    <a href="#" class="btn btn-success btn-sm btn-block dorpdown-toggle" role="button" id="dropdownMenuLink" data-bs-toggle='dropdown' aria-expanded="false">
