                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="width-16-rem lefter text-left">
                                    <a href="{{ route("content.comment.show", [2]) }}" class="btn btn-info btn-sm text-white"><i class="fa fa-eye"></i> نمایش</a>
                            ...
                            <td>تایید شده</td>
                            <td class="width-16-rem lefter text-left">
                                <a href="{{ route("content.comment.show", [1]) }}" class="btn btn-info btn-sm text-white"><i class="fa fa-eye"></i> نمایش</a>
