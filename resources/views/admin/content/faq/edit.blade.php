...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item font-size-12 active" aria-current="page"> ویرایش سوال متداول</li>
        </ol>
    </nav>
                        ...
                        <section class="row">
                            <section class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="question"
                                        value="{{ old('question', $faq->question) }}" id="">
                                    @error('question')
                            ...
                            <section class="col-12 mt-3">
                                <div class="form-group">
                                    ...
                                    <textarea name="answer" id="answer" cols="30" rows="10">{{ old('answer', $faq->answer) }}</textarea>
                                    @error('answer')
                                        <span class="alert_require bg-danger text-white py-1 px-3" role="alert"
                                            style="border-radius: 0 0 0.5rem 0.5rem; font-weight: 100">
                                            <strong>
