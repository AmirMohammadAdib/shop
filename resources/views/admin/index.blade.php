...
@section("content")
        <section class="row">
            <section class="col-lg-3 col-md-6 col-12">
                <a href="#" class="text-decoration-noen d-block my-4">
                    <section class="card bg-custom-yello text-white">
                        ...
                        <section class="card-footer">
                            ...
                            بروزرسانی شده در تاریخ 17/ 03/ 1403
                        </section>
                    </section>
                </a>
            </section>
